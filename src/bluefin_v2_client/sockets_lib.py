...
class Sockets:
    ...
    async def _establish_connection(self):
        ...
        try:
            await sio.connect(
                self.url, wait_timeout=self.timeout, transports=["websocket"]
            )
            return True
        except:
            return False
    ...
    async def open(self):
        ...
        """
        Sockets.connection_established = await self._establish_connection()
        if not Sockets.connection_established:
            await self.close()
    ...
    async def disconnect():
        ...
        # Reconnect
        Sockets.connection_established = False
    ...
    async def subscribe_orderbook_depth_streams_by_symbol(
        self, symbol: MARKET_SYMBOLS, depth=""
    ):
        """
    ...
    async def unsubscribe_orderbook_depth_streams_by_symbol(
        self, symbol: MARKET_SYMBOLS, depth=""
    ):
        """
